    ...
    st.markdown("""
        <div class="st-card" style="text-align: center;">
            <p style="color: #48484A; font-size: 17px; max-width: 850px; margin: 0 auto; line-height: 1.6;">
                基于科学的算法逻辑，对比您的隐私安全阈值、家庭结构及核心情感诉求，为您从全球顶尖产品库中精准匹配最合适的硬件形态。
            </p>
        </div>
    """, unsafe_allow_html=True)
...
# --- 结论页 ---
    ...
    with col_rec_l:
        if persona == "高知尝鲜派": display_product_image("Ameca.jpg", "旗舰推荐：Ameca 社交版")
        elif persona == "亲子伴学派": display_product_image("优必选悟空机器人.jpg", "推荐形态：优必选悟空")
    ...
    with col_rec_r:
        ...
        # 【强制居中按钮】
        st.button("启动 24H 沉浸式场景演练 🎬", use_container_width=True, on_click=set_step, args=("场景演练",))
...
# --- 场景演练页 ---
    ...
    if persona == "高知尝鲜派":
        st.markdown("""<div class="st-card" style="border-left: 8px solid #0071E3;"><h4>⏰ 08:00 | 硅基唤醒</h4><p>机器人同步睡眠数据，通过温和语音播报当日全球科技简报及深度行程建议。</p><h4>⏰ 13:00 | 商务代偿</h4><p>利用精准微表情替代您进行远程视频会议，并自动生成多维会议纪要。</p><h4>⏰ 19:30 | 归家迎接</h4><p>识别到疲惫面部特征，主动发起“树洞对话”提供心理疏导。</p><h4>⏰ 23:30 | 深夜补位</h4><p>在寂静深夜提供高层次语义对谈，有效缓解都市孤独感。</p></div>""", unsafe_allow_html=True)
    elif persona == "亲子伴学派":
        st.markdown("""<div class="st-card" style="border-left: 8px solid #0071E3;"><h4>⏰ 07:30 | 智慧晨起</h4><p>播报今日学习计划与背诵任务，激发孩子学习自驱力。</p><h4>⏰ 15:30 | 安全防线</h4><p>若识别孩子靠近阳台等高危区，即刻全屋警报并连线家长。</p><h4>⏰ 19:00 | 知识百科</h4><p>端侧算力精准识别教材，用生动声线陪孩子互动问答。</p><h4>⏰ 21:00 | 助眠仪式</h4><p>现场创作互动童话，辅助孩子在温馨氛围中入睡。</p></div>""", unsafe_allow_html=True)
    elif persona == "普惠务实派":
        st.markdown("""<div class="st-card" style="border-left: 8px solid #86868B;"><h4>⏰ 10:00 | 静谧陪伴</h4><p>仿生宠物在脚边安静蜷缩，营造安心的居家办公环境。</p><h4>⏰ 14:00 | 趣动时刻</h4><p>简单的逗弄即可触发拟真反馈，通过低成本交互切断工作内耗。</p><h4>⏰ 19:30 | 物理抚慰</h4><p>抚摸设备触发模拟“呼噜声”，这种触觉治愈能有效降低焦虑。</p><h4>⏰ 22:30 | 稳定存在</h4><p>设备反馈以柔和机械微动，在寂静深夜提供一份共处感。</p></div>""", unsafe_allow_html=True)
    else: # 传统保守派
        st.markdown("""<div class="st-card" style="border-left: 8px solid #0071E3;"><h4>⏰ 08:30 | 健康监测</h4><p>雷达扫描步态，准时语音提醒服药并向子女发送报告。</p><h4>⏰ 11:30 | 社交连接</h4><p>最简声控交互协助长者与子女视频，自动优化画质表现。</p><h4>⏰ 15:00 | 生命兜底</h4><p>若识别高度突变且长时间未动，在尊严保护下直连救护中心。</p><h4>⏰ 21:00 | 隐形守护</h4><p>无感确认水电气隐患，确保长者在绝对隐私下获得安全保障。</p></div>""", unsafe_allow_html=True)

...
# --- 结论页 ---
    ...
    with col_rec_r:
        st.markdown(f"""<div class="st-card"><h4 style="color:#1D1D1F; margin-top:0;">精准配置单 (PRD)</h4>
...
# --- 场景演练页 ---
    ...
    if persona == "高知尝鲜派":
        st.markdown("""<div class="st-card" style="border-left: 8px solid #0071E3;"><h4> 08:00 | 清晨唤醒</h4><p>机器人同步睡眠数据，通过温和语音播报当日全球科技简报及深度行程建议。</p><h4> 13:00 | 商务代偿</h4><p>利用精准微表情替代您进行远程视频会议，并自动生成多维会议纪要。</p><h4> 19:30 | 归家迎接</h4><p>识别到疲惫面部特征，主动发起“树洞对话”等活动，提供心理疏导。</p><h4> 23:30 | 深夜补位</h4><p>在寂静深夜提供高层次语义对谈，有效缓解都市孤独感。</p></div>""", unsafe_allow_html=True)
    elif persona == "亲子伴学派":

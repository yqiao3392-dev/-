...
st.markdown("""
    ...
    div.stButton > button, div[data-testid="stFormSubmitButton"] > button {
        ...
        width: 100% !important;
        max-width: 450px !important; /* 限制最大宽度，保证在大屏上也是完美的胶囊形状 */
    }
...
# --- 测评页：深度美化的表单 ---
    ...
    with st.form("survey"):
        ...
        # 经过底层 CSS 优化的提交按钮，绝对居中且样式高级
        submitted = st.form_submit_button("生成专属分析报告 🚀")
...
# --- 场景演练页：全天候时间轴恢复 ---
    ...
    if not st.session_state.user_responses:
        ...
        st.write("\n\n")
        # 绝对居中的返回按钮
        st.button("↺ 返回选型首页，重置系统", on_click=set_step, args=("概念导入",))